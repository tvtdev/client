...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CmdThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CmdThread_t qt_meta_stringdata_CmdThread = {
    {
QT_MOC_LITERAL(0, 0, 9), // "CmdThread"
QT_MOC_LITERAL(1, 10, 11), // "execCommand"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7), // "command"
QT_MOC_LITERAL(4, 31, 10) // "getCommand"

    },
    "CmdThread\0execCommand\0\0command\0"
    "getCommand"
};
...
void CmdThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->execCommand((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (CmdThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CmdThread::execCommand)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CmdThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CmdThread.data,
      qt_meta_data_CmdThread,  qt_static_metacall, nullptr, nullptr}
};
...
void *CmdThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CmdThread.stringdata0))
...
// SIGNAL 0
void CmdThread::execCommand(QString _t1)
{
